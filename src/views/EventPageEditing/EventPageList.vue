    ...
    <div class="table">
        ...
        <div class="container">
            <div class="handle-box">
                <el-form :inline="true">
                    <el-form-item>
                        <el-input clearable v-model="activity_id" placeholder="请输入活动ID"></el-input>
                    </el-form-item>
                    <el-form-item>
                        <el-input clearable v-model="activity_title" placeholder="请输入活动名称"></el-input>
                    </el-form-item>
                    <el-form-item>
        ...
        handleSaoma(data) {
            ...
            setTimeout(()=>{
                ...
                let qrcode = new QRCode('qrcode', {
                    ...
                    // text: 'http://mayun.test.dfs800.com'+data.url, // 二维码地址-测试
                })
            })
        },
