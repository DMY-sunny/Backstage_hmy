<template>
    <div>
        <div class="commodityTool" :style="cssBackground()">
            <!-- <img ref="img_height" v-if="commodityTool.module_type === 2 || commodityTool.module_type === 8" style="width:100%" :src="cdn06+commodityTool.head_img" alt="未配置头图" @load="comTopImg(data)"> -->
            ...
            <div :class="commodityTool.template">
                <div class="commodity_box" v-if='commodityTool.template === "rows_1" && ins <  1 || commodityTool.template === "rows_2" && ins <  2 || commodityTool.template === "rows_3" && ins <  3' v-for="(data,ins) in commodityTool.goods" :key="ins">
                            ...
                            <div class="commodity_price_left">
                                ...
                                <div class="price">
                                    ...
                                    <div class="price_text">
                                        <!-- <img :src="cdn04 + 'activity/Group.png'" class="Group" /> -->
                                        <div class="Group"></div>
...
.commodityTool {
    ...
    .price_text em{
        position: absolute;
        background: url("http://cdn04.dfs800.com/images/htj/activity/Group.png") no-repeat;
        overflow: hidden;
