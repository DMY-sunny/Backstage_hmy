    ...
    <div>
        ...
        <div class="right_wrap h100" v-if="show_page">
            ...
            <div>
                ...
                <div class="right_box">
                    <div v-for="(sitem,sindex) in ruleForm.goods" :key="sindex" class="div1">
                        <p>
                            <span class="text">秒杀第{{sindex + 1}}天商品id</span>
                        </p>
                        <el-input v-model="sitem.id" placeholder="填写活动商品id"></el-input>
                    </div>
                </div>
            </div>
            <div>
