    ...
    <el-dialog title="新增权限" :visible.sync="createPowerVisible" width="40%" center>
        <el-form ref="form" :model="create_power" label-width="100px">
            <!-- <el-form-item label="父级权限:">
                <el-select v-model="create_power.parent_id">
                    <el-option :label="item.name" :value="item.id" v-for="(item,index) in parentList" :key="index">
                        {{item.name}}
                    </el-option>
                </el-select>
            </el-form-item> -->
            <el-form-item label="所属项目:">
                <el-input v-model="create_power.project"/>
            </el-form-item>
            ...
            <!-- <el-form-item label="是否有效:">
                <el-radio-group v-model="create_power.type">
                    <el-radio :label="0">无效</el-radio>
                    <el-radio :label="1">有效</el-radio>
                </el-radio-group>
            </el-form-item>
            <el-form-item label="是否是菜单:">
                <el-radio-group v-model="create_power.menu_type">
